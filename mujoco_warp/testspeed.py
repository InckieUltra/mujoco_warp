...
_NCONMAX = flags.DEFINE_integer("nconmax", 20, "override maximum number of contacts for all worlds")
_NJMAX = flags.DEFINE_integer("njmax", 150, "override maximum number of constraints per world")
